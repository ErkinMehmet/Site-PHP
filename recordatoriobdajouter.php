...
<body>
<h1>Voici les informations que vous avez saisies:</h1>
...
<a href="recordatorio.php">Retourner à la page principale</a>
<?php
$reponse = $bdd->query('INSERT INTO recordatorio(inicio,fin,descripcion,categoria,estado) VALUES(\''.$inicio.'\',\''.$fin.'\',\''.$descripcion.'\',\''.$categoria.'\',\''.$estado.'\')') or die(print_r($bdd->errorInfo()));
